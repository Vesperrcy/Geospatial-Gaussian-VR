...
#
# This script writes explicit LOD chunk files such as chunk_0_0_0_L0.txt,
# chunk_0_0_0_L1.txt, and chunk_0_0_0_L2.txt. It does not write an extra
# chunk_0_0_0.txt base file, so L0 is not duplicated on disk.
#
# After this step, run lod_builder.py on the same chunk directory.

# Refs: REF-PAPER-3DGS, REF-PAPER-H3DGS, REF-PAPER-POTREE. See /REFERENCES.md.
